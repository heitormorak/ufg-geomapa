...
CREATE TABLE `amostras` (
  ...
  `num_rel` int(11) NOT NULL,
  `cooX` double NOT NULL,
  `cooY` double NOT NULL,
  `nspt12` int(11) DEFAULT NULL,
  `nspt23` int(11) DEFAULT NULL,
...
-- Dump completed on 2023-03-09 13:43:17
